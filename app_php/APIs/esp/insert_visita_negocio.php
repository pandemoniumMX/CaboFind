...
$response = array();
  ...
  $validacion = "SELECT TVN_BOOT FROM trigger_visita_negocio WHERE TVN_BOOT = '$BOOT' and TVN_VERSION= '$VERSION' and FECHA_TVN=CURDATE() and negocios_ID_NEGOCIO='$ID';";
    ...
    if (mysqli_num_rows($resul)==0) {
         ...
         $sql2 = "INSERT INTO `trigger_visita_negocio` (FECHA_TVN,IDIOMA_TVN,TVN_BOOT,TVN_VERSION, TVN_MODELO, TVN_SO, negocios_ID_NEGOCIO) VALUES (CURDATE(),'esp','$BOOT','$VERSION','$MOD','$SO','$ID');";
        $res = $conn->query($sql2);
