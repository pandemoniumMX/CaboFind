...
$response = array();
  ...
  $validacion = "SELECT TRP_BOOT FROM trigger_recomendacion_publicacion WHERE TRP_BOOT = '$BOOT' and TRP_VERSION= '$VERSION' and publicacion_ID_PUBLICACION= '$ID';";
    ...
    if (mysqli_num_rows($resul)==0) {
         ...
         $sql2 = "INSERT INTO trigger_recomendacion_publicacionx (FECHA_TRP,TRP_IDIOMA,TRP_BOOT,TRP_VERSION,TRP_MODELO,TRP_SO,publicacion_ID_PUBLICACION) VALUES (CURDATE(),'esp','$BOOT','$VERSION','$MOD','$SO','$ID');";
        // $sql2 = "INSERT INTO `trigger_visita_publicacion`     (FECHA_TVP,IDIOMA_TVP,TVP_BOOT,TVP_VERSION, TVP_MODELO, TVP_SO, publicacion_ID_PUBLICACION) VALUES (CURDATE(),'esp','$BOOT','$VERSION','$MOD','$SO','$ID');";
