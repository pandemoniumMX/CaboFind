...
$sql=$conn->query("SELECT n.ID_NEGOCIO,n.NEG_NOMBRE,n.NEG_DESCRIPCION, n.NEG_MAP,n.NEG_MAP_IOS,n.NEG_LUGAR, n.NEG_FACEBOOK,n.NEG_INSTAGRAM,n.NEG_WEB, c.CAT_NOMBRE,s.SUB_NOMBRE,s.SUB_NOMBRE_ING, g.GAL_FOTO,n.NEG_TEL, n.NEG_CORREO, n.NEG_HORARIO  
