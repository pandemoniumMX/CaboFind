...
$sql=$conn->query("SELECT n.ID_NEGOCIO,n.NEG_NOMBRE,n.NEG_DESCRIPCION,n.NEG_ETIQUETAS,n.NEG_ETIQUETAS_ING, n.NEG_MAP,n.NEG_LUGAR,n.NEG_FACEBOOK,n.NEG_INSTAGRAM,n.NEG_WEB, c.CAT_NOMBRE,s.SUB_NOMBRE,s.SUB_NOMBRE_ING, g.GAL_FOTO  
