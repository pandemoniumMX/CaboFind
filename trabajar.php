...
<head>
    ...
    <!-- Title  -->
    <title>Requisitos para trabajar con nosotros</title>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-10 col-lg-8">
                    <div class="contact-form">
                        <h5>Requisitos</h5>
                        <p style="color:black">
                            Para formar parte de nuestro equipo, necesitas cumplir con ciertos requisitos:</br></br>

                            •	Tener mínimo 5 años establecidos en el mismo lugar.</br>
                            •	Presencia fiscal.</br>
