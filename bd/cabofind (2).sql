...
-- Tiempo de generación: 17-05-2019 a las 03:28:32
...
(1, 'Mexicana', 1, 'A', 'restaurantes_mex.php'),
(2, 'Italian', 1, 'A', 'restaurantes_ita.php'),
(3, 'Japonesa', 1, 'A', 'restaurantes_jap.php'),
(4, 'China', 1, 'A', 'restaurantes_chi.php'),
(5, 'Comida rapida', 1, 'A', 'restaurantes_fas.php'),
(6, 'Mariscos', 1, 'A', 'restaurantes_sea.php'),
(7, 'Cafeteria', 1, 'A', 'restaurantes_caf.php'),
(8, 'Snacks', 1, 'A', 'restaurantes_sna.php'),
(9, 'Teatros', 5, 'A', 'freetime_theater.php'),
(10, 'Eventos musicales', 5, 'A', 'freetime_music.php'),
(11, 'Actividades', 5, 'A', 'freetime_act.php'),
(12, 'SportBars', 4, 'A', 'bars_sport.php'),
(13, 'Rockbars', 4, 'A', 'bars_rock.php'),
(14, 'Terraza', 4, 'A', 'bars_terrace.php'),
(15, 'Nightclubs', 4, 'A', 'bars_night.php'),
(16, 'Bar restaurante', 4, 'A', 'bars_res.php'),
(17, 'Ladies night', 4, 'A', 'bars_lady.php'),
(18, 'Tiendas de ropa', 3, 'A', 'shopping_clot.php'),
(19, 'Farmacias', 3, 'A', 'shopping_pha.php'),
(20, 'Joyería', 3, 'A', 'shopping_jew.php'),
(21, 'Supermercado', 3, 'A', 'shopping_sup.php'),
(22, 'Autopartes', 3, 'A', 'shopping_auto.php'),
(23, 'Medicos', 2, 'A', 'services_med.php'),
(24, 'Tecnicos', 2, 'A', 'services_tech.php'),
(25, 'Talleres', 2, 'A', 'services_wor.php'),
(26, 'Transporte', 2, 'A', 'services_tra.php'),
(27, 'Playas', 5, 'A', 'freetime_bea.php'),
(28, 'Fotografia', 2, 'A', 'services_pho.php');
...
(1, 'Actividades acuaticas', 11, 'A'),
(2, 'Actividades terrestres', 11, 'A'),
(3, 'Actividades aereas', 11, 'A'),
(4, 'Sport', 18, 'A'),
(5, 'Accesorios', 18, 'A'),
(6, 'Boutique', 18, 'A'),
(7, 'Hospitales publicos', 23, 'A'),
(8, 'Hospitales privados', 23, 'A'),
(9, 'Farmacias', 23, 'A'),
(10, 'Especialidades', 23, 'A'),
(11, 'Computadoras', 24, 'A'),
(12, 'Televisiones', 24, 'A'),
(13, 'Audio', 24, 'A'),
(14, 'Llanteras', 25, 'A'),
(15, 'Servicios generales', 25, 'A'),
(16, 'Carroceros', 25, 'A'),
(17, 'Publico', 26, 'A'),
(18, 'Taxy', 26, 'A'),
(19, 'Renta de autos', 26, 'A');
