                            ...
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="index.html">Restaurantes</a>
                                        <a class="dropdown-item" href="catagory.html">Comida rápida</a>
                                    </div>
                                </li>
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="index.html">Reparación</a>
                                        <a class="dropdown-item" href="index.html">Instalación</a>
                                        <a class="dropdown-item" href="catagory.html">Cajeros</a>
                                        <a class="dropdown-item" href="catagory.html">Bancos</a>
                                        <a class="dropdown-item" href="catagory.html">Transporte</a>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="index.html">Compra venta</a>
                                        <a class="dropdown-item" href="catagory.html">Tiendas departamentales</a>
                                        <a class="dropdown-item" href="regular-page.html">Boutiques</a>
                                    </div>
                                </li>
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="index.html">Antros</a>
                                        <a class="dropdown-item" href="index.html">Bares</a>
                                    </div>
                                </li>
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="index.html">Tours turísticos</a>
                                        <a class="dropdown-item" href="index.html">Tiempo en familia</a>
                                        <a class="dropdown-item" href="index.html">Teatro</a>
                                        <a class="dropdown-item" href="index.html">Conciertos</a>
                                    </div>
                                </li>
