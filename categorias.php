                ...
                <div class="col-12 col-md-8 col-lg-4 left">
                    <div class="post-sidebar-area wow fadeInUpBig" data-wow-delay="0.2s">
                        ...
                        <div class="sidebar-widget-area">
                            <h5 class="title">Estilo de cocina y platillos</h5>
                            <div class="widget-content">
                                <input type="radio" name="gender" value="male" > Mexicana<br>
                        ...
                        <div class="sidebar-widget-area">
                            <h5 class="title">Servicio a domicilio</h5>
                            <div class="widget-content">
                        ...
                        <div class="sidebar-widget-area">
                            <h5 class="title">Características del sitio</h5>
                            <div class="widget-content">
                                <input type="checkbox" name="gender" value="male" > Instalaciones apropiadas para descapacitados <br>
                        ...
                        <!-- Catagory Area -->
                                        ...
                                        <div class="world-catagory-area">
                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                <li class="title">Restaurantes</li>
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" id="tab2" data-toggle="tab" href="#world-tab-2" role="tab" aria-controls="world-tab-2" aria-selected="false">Cocina local</a>
                                                </li>

                                                <li class="nav-item">
                                                    <a class="nav-link" id="tab3" data-toggle="tab" href="#world-tab-3" role="tab" aria-controls="world-tab-3" aria-selected="false">Cocina gourmet</a>
                                                </li>

                                                <li class="nav-item">
                                                    <a class="nav-link" id="tab4" data-toggle="tab" href="#world-tab-4" role="tab" aria-controls="world-tab-4" aria-selected="false">Cocina econimica</a>
                                                </li>

                                                <li class="nav-item">
                                                    <a class="nav-link" id="tab5" data-toggle="tab" href="#world-tab-5" role="tab" aria-controls="world-tab-5" aria-selected="false">Almuerzos</a>
                                                </li>
