											...
											<div class="card-content table-responsive table-full-width">
												<table class="table table-striped">
													...
													<tbody>
															<?php
																$sql1= "SELECT *
																FROM equipos ORDER BY equipos.ID_EQUIPOS ASC";
																$resultado = $conn->query($sql1);
																if($resultado->num_rows > 0){
																	while($row = $resultado->fetch_assoc()){
																		echo "<form id='form2' method='post' action='../assets/db/borrado_equipos.php' > \n";
																		...
																		echo "<td> \n";
																		echo "<input type='submit' class='btn btn-xs btn-danger btn-info'>\n";
																		echo "</form> \n";
																		echo "</td>";
																		echo "</tr>"."\n";
																	}
