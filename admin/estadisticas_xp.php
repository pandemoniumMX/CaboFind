<?php
    ...
    if($usu_tip != "Admin") {
      ...
      trigger_visita_publicacion.`IDIOMA_TVP`,
      COUNT(trigger_visita_publicacion.publicacion_ID_PUBLICACION) AS Total
      FROM
        publicacion
      LEFT JOIN trigger_visita_publicacion ON publicacion.ID_PUBLICACION = 
      trigger_visita_publicacion.publicacion_ID_PUBLICACION
      WHERE trigger_visita_publicacion.publicacion_ID_PUBLICACION=$id
      GROUP BY publicacion.ID_PUBLICACION,trigger_visita_publicacion.`IDIOMA_TVP`";  

      $query2="SELECT * FROM publicacion WHERE ID_PUBLICACION=$id";
...
<script type="text/javascript">  
           ...
           {  
                var data = google.visualization.arrayToDataTable([  
                          ...
                          {  
                               echo "['".$row["IDIOMA_TVP"]."', ".$row["Total"]."],";  
                          }  
                          ?>  
                     ]);  
                     var options = {  
                      title: 'Diagrama de visitas a publicación en Español e inglés',  
                      //is3D:true,  
                      pieHole: 0.4  
                     };  
