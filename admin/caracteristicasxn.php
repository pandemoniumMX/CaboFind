<?php
    ...
    $empresa="SELECT * from negocios where ID_NEGOCIO=$id_neg";
      ...
      $car="SELECT n.ID_CARACTERISTICAS, n.CAR_NOMBRE, e.NEG_CAR_ESTATUS, e.ID_NEG_CAR
      FROM   caracteristicas  n, neg_car e
      WHERE n.ID_CARACTERISTICAS = e.caracteristicas_ID_CARACTERISTICAS and e.negocios_ID_NEGOCIO=$id_neg";
...
//insertar caracetrsitica a negocio
   ...
   html:
   '<div class="col-lg-12"> <form action="caracteristicasxn_car_insert_fn.php" method="post" name="data">'+
   <?php
...
//ventana de nuevo cliente
   ...
   title: 'Características ',
   html:
   '<div class="col-lg-12"> <form action="caracteristicasxn_update_fn.php" method="post" name="data">'+
   ...
   '<strong class="card-title mb-3">Asignar caracteristica a empresa</strong> </br>'+
    ...
    '</br>'+
    '<button type="submit"  class="btn btn-success btn-lg btn-block">Actualziar</button>'+
   '</form></div>',
   showCancelButton: true,
   confirmButtonColor: '#3085d6',
   cancelButtonColor: '#d33',
  ...
  <script>
        ...
        url : 'caracteristicasxn_get_fn.php',
