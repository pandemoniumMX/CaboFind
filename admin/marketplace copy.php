...
<li class="has-sub">
    ...
    <div class="page-content--bgf7"></br>
          <div class="container">
                    ...
                    <button class="btn btn-primary" data-toggle="modal" data-target="#largeModal" >Nuevo anunciante y anuncio</button>
                    <button class="btn btn-success" data-toggle="modal" data-target="#largeModal1" >Nuevo anunciante</button>
                    <button class="btn btn-info" data-toggle="modal" data-target="#largeModal2" >Nuevo anuncio</button>
                    </div>
                    <div class="container-fluid">
