                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                    <textarea name="textarea-input" id="textarea-input" rows="9" placeholder="Separadas con una coma..." class="form-control"></textarea>
                                            </div>
        </br>
...
<div class="row">
                        ...
                        <div class="card">
                                <div class="card-body">
                                     ...
                                     <label>Alcance de exposición</label>
                        ...
                        <div class="card">
                                ...
                                <div class="row">
<div class="col-lg-6">
<button type="button"  id='look-me2' class="btn btn-danger btn-lg btn-block">Atras</button>
</div>
<div class="col-lg-6">
<button type="button" id='look-me4' class="btn btn-success btn-lg btn-block">Siguiente</button>
</div>
</div>  
