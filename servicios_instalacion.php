...
$instalaciones = "SELECT * FROM subcategoria where ID_CATEGORIA='7' and SUB_ESTATUS='A';";  //reparacion
                        ...
                        <div class="sidebar-widget-area">
                            ...
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <?php
                                    $ejec1 = mysqli_query($conn, $instalaciones);
                                    while($fila=mysqli_fetch_array($ejec1)){
                                        $nom          = $fila['SUB_NOMBRE'];  
                                      //  $url          = $fila['CAT_URL'];                                                                                   
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="single-blog-post wow fadeInUpBig" data-wow-delay="0.2s">
                                                ...
                                                <!-- ========= Carrusel con flecha adelantre y atras ========= -->
