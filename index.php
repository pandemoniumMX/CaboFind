...
<body>
    ...
    <div class="hero-area">
        ...
        <div class="hero-slides owl-carousel">
            ...
            <div class="single-hero-slide bg-img background-overlay" style="background-image: url(assets/img/blog-img/bg1x.jpg);"></div>

            <div class="single-hero-slide bg-img background-overlay" style="background-image: url(assets/img/blog-img/bg3x.jpg);"></div>
            <div class="single-hero-slide bg-img background-overlay" style="background-image: url(assets/img/blog-img/bg4x.jpg);"></div>

            <div class="single-hero-slide bg-img background-overlay" style="background-image: url(assets/img/blog-img/bg2x.jpg);"></div>
                    ...
                    <div class="post-content-area mb-50">
                        ...
                        <div class="world-catagory-area">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="title">No te lo pierdas</li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="tab2" data-toggle="tab" href="#world-tab-2" role="tab" aria-controls="world-tab-2" aria-selected="false">Lo más visto</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" id="tab3" data-toggle="tab" href="#world-tab-3" role="tab" aria-controls="world-tab-3" aria-selected="false">Promociones</a>
                                </li>
                ...
                <div class="col-12 col-md-8 col-lg-4">
                    <div class="post-sidebar-area wow fadeInUpBig" data-wow-delay="0.2s">
                        ...
                        <div class="sidebar-widget-area">
                            <h5 class="title">Acerca de CaboFind</h5>
                        ...
                        <!-- Widget Area -->
                        <div class="sidebar-widget-area">
                            <h5 class="title">Lo mas nuevo</h5>
                            <div class="widget-content">
                                <!-- Single Blog Post -->
                        ...
                        <div class="sidebar-widget-area">
                            ...
                            <div class="widget-content">
                                ...
                                <div class="single-blog-post todays-pick">
                                    <!-- Post Thumbnail -->
                                    <div class="post-thumbnail">
                                        <img src="assets/img/blog-img/b22.jpg" alt="">
                                    </div>
                                    <!-- Post Content -->
